...
; (function (window) {	// 还没封装好
	function scrollBarFx(options) {
		if (this instanceof scrollBarFx) {
			...
			this._calcBar();
			this.rollerEvent({ a: 'y', s: 'Height', s1: 'height', p: 'top', o: 'offsetTop' });
			if (this.options.canDrag) this.drag({ a: 'y', s: 'Height', s1: 'height', p: 'top', o: 'offsetTop' });
			if (this.options.xAxis) this.drag({ a: 'x', s: 'Width', s1: 'width', p: 'left', o: 'offsetLeft' });
	...
	scrollBarFx.prototype._calcBar = function () {
		this.axisRoll({ a: 'y', s: 'Height', s1: 'height', p: 'top', o: 'offsetTop' });
		if (this.options.xAxis) this.axisRoll({ a: 'x', s: 'Width', s1: 'width', p: 'left', o: 'offseLeft' });
	};
	...
	scrollBarFx.prototype.axisRoll = function (dir) {
		var _opts = this.options;
		this[dir.a + '_displaySize'] = _opts.displayArea['client' + dir.s];
		this[dir.a + '_contentSize'] = _opts.contentArea['offset' + dir.s];
		_opts[dir.a + '_barWrap'].style.opacity = this[dir.a + '_contentSize'] > this[dir.a + '_displaySize'] ? 1 : '';

		// 每次计算滚动条回到顶部
		this[dir.a + '_barPos'] = 0;
		_opts[dir.a + '_bar'].style[dir.p] = 0;
		_opts.contentArea.style[dir.p] = 0;

		this[dir.a + '_oldDisplaySize'] = this[dir.a + '_displaySize'];

		if (this[dir.a + '_contentSize'] <= this[dir.a + '_displaySize']) return;

		this[dir.a + '_barWrap'] = _opts[dir.a + '_barWrap']['client' + dir.s];
		// 正常滚动条的高度
		this[dir.a + '_norbar'] = this[dir.a + '_displaySize'] / this[dir.a + '_contentSize'] * this[dir.a + '_barWrap'];
		// 当前滚动条的高度。最大高度 barParent 的高度
		this[dir.a + '_curbar'] = Math.min(this[dir.a + '_norbar'], _opts['max' + dir.s]);
		// 滚动条最小高度 30px
		this[dir.a + '_curbar'] = Math.max(this[dir.a + '_curbar'], _opts['min' + dir.s]);

		// 手动设置滚动条后的一个差值
		this[dir.a + '_cbarRatio'] = (this[dir.a + '_barWrap'] - this[dir.a + '_norbar']) / (this[dir.a + '_barWrap'] - this[dir.a + '_curbar']);
		// 默认的滚动条的滚动路程 与 内容滚动距离的比值 / 手动设置的差值
		this[dir.a + '_barRatio'] = this[dir.a + '_norbar'] / this[dir.a + '_displaySize'] / this[dir.a + '_cbarRatio'];
		_opts[dir.a + '_bar'].style[dir.s1] = this[dir.a + '_curbar'] + 'px';
	};

	scrollBarFx.prototype.rollerEvent = function (dir) {
		var _this = this, _opts = _this.options;
		_this.mouseWheel(_opts.displayArea, function upFn(e, rate) {
			if (_this[dir.a + '_contentSize'] <= _this[dir.a + '_displaySize']) return;

			e.preventDefault();
			// 滚动距离
			_this[dir.a + '_barPos'] -= _opts.speed * rate;
			// 边界判断
			if (_this[dir.a + '_barPos'] < 0) _this[dir.a + '_barPos'] = 0;
			// 滚动条的运动
			_opts[dir.a + '_bar'].style[dir.p] = _this[dir.a + '_barPos'] + 'px';
			// 内容的滚动
			_opts.contentArea.style[dir.p] = -_this[dir.a + '_barPos'] / _this[dir.a + '_barRatio'] + 'px';
			...
			_this[dir.a + '_barPos'] += _opts.speed * rate;
			// 边界判断
			if (_this[dir.a + '_barPos'] > _this[dir.a + '_barWrap'] - _this[dir.a + '_curbar']) _this[dir.a + '_barPos'] = _this[dir.a + '_barWrap'] - _this[dir.a + '_curbar'];
			// 滚动条的运动
			_opts[dir.a + '_bar'].style[dir.p] = _this[dir.a + '_barPos'] + 'px';
			// 内容的滚动
			_opts.contentArea.style[dir.p] = -_this[dir.a + '_barPos'] / _this[dir.a + '_barRatio'] + 'px';
	...
	scrollBarFx.prototype.drag = function (dir) {
		var _this = this, _opts = _this.options;
		mDrag({
			moveEle: _opts[dir.a + '_bar'],
			['disable'+dir.a.toUpperCase]: true,
			moveFn() {
				_this[dir.a + '_barPos'] = _opts[dir.a + '_bar'][dir.o];
				_opts.contentArea.style[dir.p] = -_this[dir.a + '_barPos'] / _this[dir.a + '_barRatio'] + 'px';
			},
			moveScrop: document
		});
