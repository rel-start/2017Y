    ...
    $.Zebra_Tooltips = function(elements, options)
    {
        ...
        var _create_tooltip = function($element)
        {
            ...
            if(tooltip_info.window_resized || tooltip_info.window_scrolled)
            {
                ...
                // console.log('position:left是：'+tooltip_left+'=='+tooltip_info.element_left+'==='+tooltip_info.tooltip_width+'==='+tooltip_info.arrow_width)
                // console.log('position:right是：'+tooltip_left+'=='+tooltip_info.element_left+'==='+tooltip_info.element_width+'==='+tooltip_info.arrow_width)
